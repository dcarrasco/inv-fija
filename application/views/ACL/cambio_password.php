<div class="row">
	...
	<div class="col-md-6 col-md-offset-3 well">
		...
		<?= form_open('login/cambio_password/' . $usr, 'id="frm_login" class="form-horizontal"'); ?>
			...
			<div class="control-group col-md-8 col-md-offset-2 <?= form_has_error('usr'); ?>">
			...
			<div class="control-group col-md-8 col-md-offset-2 <?= form_has_error('pwd_old'); ?>">
			...
			<div class="control-group col-md-8 col-md-offset-2 <?= form_has_error('pwd_new1'); ?>">
			...
			<div class="control-group col-md-8 col-md-offset-2 <?= form_has_error('pwd_new2'); ?>">
