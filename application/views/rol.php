<div class="content-module">
	...
	<div class="content-module-heading cf">
		...
		<div class="fr">
			<a href="#" class="button b-active round ic-desplegar fl" id="btn_mostrar_agregar">Nuevo rol ...</a>
		</div>
	...
	<div class="content-module-main-agregar" style="display: none;">
		...
		<table>
			...
			<tr>
				...
				<td class="ac">
					<?php echo form_input('agr-rol', set_value('agr-rol'), 'maxlength="50" size="50"'); ?>
					<?php echo form_error('agr-rol'); ?>
				</td>
				<td class="ac">
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php echo form_input($reg['id'].'-rol', set_value($reg['id'].'-rol', $reg['rol']),'maxlength="50" size="50"'); ?>
						<?php echo form_error($reg['id'].'-rol'); ?>
					</td>
					<td>
					...
					<td>
						<?php echo form_multiselect($reg['id'].'-modulo[]', $combo_modulos[$reg['id_app']], set_value($reg['id'].'-modulo[]', $modulos_rol[$reg['id']]),'size="5"'); ?>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('a.boton-borrar').click(function (event) {
			...
			if (confirm('Seguro que desea borrar el rol id=' + id_borrar)) {
