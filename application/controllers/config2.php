...
class config2 extends CI_Controller {
	...
	private $arr_menu = array(
				'auditor_model'         => array('url' => '/config2/listado/auditor_model', 'texto' => 'Auditores'),
				'familia_model'         => array('url' => '/config2/listado/familia_model', 'texto' => 'Familias'),
				'catalogo_model'        => array('url' => '/config2/listado/catalogo_model', 'texto' => 'Materiales'),
				'tipo_inventario_model' => array('url' => '/config2/listado/tipo_inventario_model', 'texto' => 'Tipos de inventario'),
				'inventario_model'      => array('url' => '/config2/listado/inventario_model', 'texto' => 'Inventarios'),
				//'detalle_inventario' => array('url' => '/config2/listado/detalle_inventario', 'texto' => 'Detalle inventario'),
				'tipo_ubicacion_model' => array('url' => '/config2/listado/tipo_ubicacion_model', 'texto' => 'Tipos Ubicacion'),
				'ubicaciones_model'    => array('url' => '/config2/ubicacion_tipo_ubicacion', 'texto' => 'Ubicaciones'),
				'centro_model'         => array('url' => '/config2/listado/centro_model', 'texto' => 'Centros'),
				'almacen_model'        => array('url' => '/config2/listado/almacen_model', 'texto' => 'Almacenes'),
				'unidad_medida_model'  => array('url' => '/config2/listado/unidad_medida_model', 'texto' => 'Unidades de medida'),
