...
class acl_test extends TestCase {
	...
	{
		$this->assertInternalType('object', Acl::create());
	}

	public function test_rules_login()
	{
		$this->assertNotEmpty(Acl::create()->rules_login);
	}

	public function test_rules_captcha()
	{
		$this->assertNotEmpty(Acl::create()->rules_captcha);
	}

	public function test_rules_change_password_validation()
	{
		$this->assertNotEmpty(Acl::create()->change_password_validation);
	}
	...
	// 	$this->assertEquals($acl->get_user('test'), 'session_user');
	// }
	...
	// 	$this->assertEquals($acl->get_id_usr(), '1');
	// 	$this->assertEquals($acl->get_id_usr('test'), '1');
	// }
	...
	// 	$this->assertEquals($acl->get_user_firstname(), 'Nombre1');

	// 	app('db')->mock_set_return_result([0 => ['nombre' => 'Nombre1Apellido1Apellido2']]);
	// 	$this->assertEquals($acl->get_user_firstname(), 'Nombre1Apellido1Apellido2');

	// 	app('session')->mock_set_userdata('user_firstname', 'first_name_from_session');
	// 	$this->assertEquals($acl->get_user_firstname(), 'first_name_from_session');
	// }
	...
	public function test_is_user_logged()
	{
		...
		$this->assertFalse($acl->is_user_logged());
	...
	// {
	// 	$this->assertFalse($this->get_method('_is_user_remembered'));
	...
	// 	$this->assertEquals((array) $acl->get_user_menu('usuario'), (array) collect($arr_menu_app));
	// }
	...
	// 	// ]);
	// 	// $this->assertEquals($this->get_method('_get_llaves_modulos', 'usuario'), ['llave_modulo1', 'llave_modulo2', 'llave_modulo3']);
	// }
	...
	// 	$this->assertInternalType('string', $this->get_method('_create_salt'));
	// 	$this->assertEquals(strlen($this->get_method('_create_salt')), $largo_salt_algo + 22);

	// 	$this->assertInternalType('string', $this->get_method('_create_salt', 10));
	// 	$this->assertEquals(strlen($this->get_method('_create_salt', 10)), $largo_salt_algo + 10);
	// }
	...
	// 	$this->assertEquals(strlen($this->get_method('_hash_password', 'password')), 60);
	// }
