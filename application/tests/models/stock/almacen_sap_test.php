 ...
 * @link     localhost:1520
 */
class almacen_sap_test extends TestCase {

	public function test_new()
	{
		$this->assertInternalType('object', Almacen_sap::create());
	}

	public function test_has_fields()
	{
		$this->assertNotEmpty(Almacen_sap::create()->get_fields());
		$this->assertCount(7, Almacen_sap::create()->get_fields());
	}
